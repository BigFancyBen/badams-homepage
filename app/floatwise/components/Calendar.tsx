...
export function Calendar({ selectedDate, onDateSelect }: CalendarProps) {
  ...
  return (
    <div className="w-full mb-4 sm:mb-8">
      <h2 className="text-lg sm:text-xl font-semibold mb-2 sm:mb-4 text-gray-900 dark:text-gray-100">Select Date</h2>
          ...
          return (
            <button
              ...
              className={`
                ...
                ${isToday && !isSelected ? 'ring-2 ring-blue-200 dark:ring-blue-700' : ''}
              `}
            >
