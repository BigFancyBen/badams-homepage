...
export function LocationManager({ locations, onAddLocation, onRemoveLocation }: LocationManagerProps) {
  ...
  return (
    <div className="w-full mb-4 sm:mb-6">
      <div className="flex items-center justify-between mb-3 sm:mb-4">
        <h2 className="text-lg sm:text-xl font-semibold text-gray-900 dark:text-gray-100">Weather Locations</h2>
        <button
      ...
      {locations.length === 0 && (
        <div className="text-center py-6 sm:py-8 text-gray-500 dark:text-gray-400 border-2 border-dashed border-gray-300 dark:border-gray-600">
          ...
          <p className="text-xs sm:text-sm">Click the + button to add locations</p>
        </div>
      )}
