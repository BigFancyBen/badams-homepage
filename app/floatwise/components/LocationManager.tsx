  ...
  return (
    <div className="">
      ...
      {locations.length === 0 && (
        <button
          onClick={() => setIsModalOpen(true)}
          className="w-full text-center py-6 sm:py-8 text-gray-500 dark:text-gray-400 border-2 border-dashed border-gray-300 dark:border-gray-600 hover:border-gray-400 dark:hover:border-gray-500 hover:text-gray-600 dark:hover:text-gray-300 transition-colors cursor-pointer"
        >
          <p className="mb-2 text-sm sm:text-base">No locations added yet</p>
          <p className="text-xs sm:text-sm">
            Click here or the + button above to add locations
          </p>
        </button>
      )}
