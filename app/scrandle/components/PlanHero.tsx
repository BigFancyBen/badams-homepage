...
const TAGS = ["Cloudflare Workers", "D1", "R2", "Discord bot", "next/og", "Elo"];
    ...
    <section id="overview" className="scroll-mt-28 pt-12 md:pt-20 pb-12">
      ...
      >
        ...
        <p
          ...
          style={{ color: ACCENT }}
        >
          A food bracket that lives in a Discord channel
        </p>
        ...
        <dl className="mt-8 grid grid-cols-2 md:grid-cols-4 gap-px" style={{ backgroundColor: "rgba(255,255,255,0.08)" }}>
          {STAT_LINE.map((stat) => (
            <div
              key={stat.label}
              className="p-4"
