      ...
      >
        ...
        <div
          ...
          style={{
            ...
            clipPath: "polygon(0 100%, 0 30%, 15% 0, 85% 0, 100% 30%, 100% 100%)",
          }}
        />
        ...
        >
          ...
          <div
            ...
            style={{
              background: "linear-gradient(90deg, #1a1a4a 0%, #2a2a6a 50%, #1a1a4a 100%)",
          ...
          >
            ...
            <div className="flex-shrink-0">
              <svg width="16" height="14" viewBox="0 0 16 14" fill="none">
                <path d="M0 2V12C0 13.1 0.9 14 2 14H14C15.1 14 16 13.1 16 12V4C16 2.9 15.1 2 14 2H8L6 0H2C0.9 0 0 0.9 0 2Z" fill="#f5c542"/>
                <path d="M0 4H16V12C16 13.1 15.1 14 14 14H2C0.9 14 0 13.1 0 12V4Z" fill="#f5d442"/>
              </svg>
            </div>
