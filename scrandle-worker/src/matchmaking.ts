 ...
 * like it should cover this and does not. 539 of the 577 in the pool have
 * never played and the pick among them is random, so a new one joins the back
 * of a queue about three months deep — it is unplayed alongside five hundred
 * others, not ahead of them. The fresh slot fires on one primary in four and
 * helps, but it draws one photograph at a time. This draws the week.
 *
